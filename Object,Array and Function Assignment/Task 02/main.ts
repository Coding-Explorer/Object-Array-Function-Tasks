...
//Here's i'm gonna to Start with an array of elements in a scrambled order.  
const scrambledArray = ["student", "of",true, 123, "am", "a", "GIAIC", "I"];

//Now implementing the usage of different kind of Methods. 
...
//Now using the method of join() to combine the elements into a single string.
